...
def main():
    ...
    daysFr2 = ["Dim", "Lun", "Mar", "Mer", "Jeu", "Ven"]
    ...
    # with open("Exercise Files/02 BuiltIn Functions/testfile.txt","r") as fp:
    ...
    # TODO: use enumerate and zip to combine sequences
    for i,m in enumerate(zip(days,daysFr2),start=1):
